...
typedef SWIFT_ENUM(NSInteger, ArrowDirection, open) {
  ArrowDirectionUp = 0,
...
SWIFT_CLASS("_TtC8Plotline17ElementSearchTask")
@interface ElementSearchTask : NSObject <UIScrollViewDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8Plotline22PlotlineFloatingButton")
@interface PlotlineFloatingButton : UIStackView
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
...
@property (nonatomic) enum ArrowDirection popoverType;
...
@property (nonatomic, readonly, strong) UIView * _Nonnull blackOverlay;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
